...
class AnnotationForm(TransactionalForm[Annotation]):
    model = Annotation
    ...
    def __init_ui(self):
        ...
        references: list[Reference] = sorted(Reference.select())
        ...
        self.start_field.setValue(self.instance.start or 1)
        self.end_field.setValue(self.instance.end or 1)
